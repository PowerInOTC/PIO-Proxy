...
class WorkerController {
  ...
  public static getInstance(
    ...
    if (!WorkerController.instances.has(workerName)) {
      WorkerController.instances.set(
        workerName,
        new WorkerController(filePath),
      );
    }

    return WorkerController.instances.get(workerName)!;
  }
